...
import com.example.arabic_unity.utils.ExoPlayerViewManager
...
fun MainPlayerView(
    ...
    Column(
        ...
        CommonButton(text = if (isLyricShowing.value) stringResource(R.string.hide_lyric) else stringResource(
                    R.string.see_lyric)
                ) {
